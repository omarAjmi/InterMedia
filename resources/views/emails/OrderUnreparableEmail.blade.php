					...
					<tr>
						<td width="100%">
							<table width="120" align="left" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" style="text-align: center;"><a href="{{ route('user.orders', Auth::id()) }}"><img src="/images/order.png" width="120px" style="border-radius:3px;" alt="Logo" border="0"></a>
									</td>
								</tr>
							</table>
								...
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
										...
										<span style="line-height: 30px; font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#313131">
                                            Votre Commande a été créer avec succés.<br>
											...
											Nous sommes désolés de vous informer que votre panne est irréparable et vous êtes invités à nous contacter via notre site Web ou directement visiter notre magasin pour plus d'informations
                                        </span>
									</td>
								</tr>
							</table>
