				...
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="50%" style="text-align:left;">
							<a href="{{ route('welcome') }}"><img src="{{ route('welcome') }}/images/log2.png" alt="Logo" border="0" style="width: 50px;height: 50px;"></a>
						</td>
						<td width="50%" style="text-align:right;">
							<table align="right" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><a href="#"><img src="{{ route('welcome') }}/images/facebook.png" alt="Facebook" border="0"></a></td>
									<td style="padding-left:10px;"><a href="#"><img src="{{ route('welcome') }}/images/instagram.png" alt="Instagram" border="0"></a></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td width="100%">
							<table width="120" align="left" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" style="text-align: center;"><a href="{{ route('user.orders', Auth::id()) }}"><img src="{{ route('welcome') }}/images/order.png" width="120px" style="border-radius:3px;" alt="Logo" border="0"></a>
									</td>
								</tr>
							</table>
